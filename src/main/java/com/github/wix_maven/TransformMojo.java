...
/**
 * Reference - transform between different locales torch.exe -p -t language SampleMulti.msi
 * Sample_Hu-hu.msi -out hu-hu.mst torch.exe -p -t language SampleMulti.msi Sample_Fr-fr.msi -out
 * fr-fr.mst
 */
/**
