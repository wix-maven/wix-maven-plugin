 ...
 */
@Mojo(name = "prepare-package", requiresProject = true,
...
public class PreparePackageMojo extends AbstractPackageable {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    if (cultures.contains(null)) { // cultures.isEmpty() shouldn't hit always add at least 1 culture
                                   // null in defaultLocale
